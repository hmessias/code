...
def gen_user_report(users_sup_groups, output_file='user_report_refactored.txt'):

    file_dir = os.path.dirname(__file__)
    file_path = os.path.join(file_dir, 'user_report_refactored.txt') #uses the current directory
